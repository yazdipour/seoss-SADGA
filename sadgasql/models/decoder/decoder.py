...
from sadgasql.models.decoder import attention, variational_lstm
from sadgasql.models.decoder.infer_tree_traversal import InferenceTreeTraversal
from sadgasql.models.decoder.train_tree_traversal import TrainTreeTraversal
from sadgasql.models.decoder.tree_traversal import TreeTraversal
...
@registry.register('decoder', 'Decoder')
class Decoder(torch.nn.Module):
    ...
    def __init__(
        ...
        if use_align_mat:
            from sadgasql.models.decoder import spider_dec_func
